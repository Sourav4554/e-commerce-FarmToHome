import {
  fetchvendorService,
  filterService,
  fetchvendorFiltersService,
  fetchVendorDetailsService,
...
//fetch vendor details for customer
const fetchVendorDetailsController = async (req, res, next) => {
  try {
    const vendor = await fetchVendorDetailsService(req.params);
    return res.status(200).json({
      success: true,
      vendor: vendor,
    });
