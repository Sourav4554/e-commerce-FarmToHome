...
const VendorTable = ({ vendors = [], loading = false, onBlockVendor }) => {
  const tableHeadings = [
    "Name",
    "Email",
    "Phone",
              ...
              >
                ...
                <td className="px-6 py-4 text-right">
                  <button 
                    ...
                    onClick={() => onBlockVendor?.(vendor._id, vendor.blockByAdmin)}
                    aria-label={vendor.blockByAdmin ? 'Unblock vendor' : 'Block vendor'}
                  >
